...
import "./index-quick.scss";

export default function IndexQuick() {
  return (
    <>
      <View className="top">
        <View className="top-qr">
          <Image
            className="qr-image"
      ...
      <View className="list">
        <View className="item">
          <View className="item-author"></View>
          <View className="item-right">
            <View className="item-derive">Redmi K60s</View>
            <View className="item-time">2022-03-01 12:00</View>
            <View className="item-body">
              <View className="file">
                <View className="file-info">
                  <View className="file-name">文件名</View>
                  <View className="file-size">1.2MB</View>
                </View>
